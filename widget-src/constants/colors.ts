...
export const COLOR_SUCCESS = "#22C59F";           // Green 500
export const COLOR_MOVE = "#14D7C0";              // Emerald 400 — brighter, pastel green for Move toggle
export const COLOR_MOVE_BG = "#D1FAF5";          // Emerald 100 — light green background for Move checkbox
...
export const DARK_COLOR_MOVE_BG = "#008273";          // Emerald 900 — dark green bg for Move checkbox
